...
SCHEME_VARIANTS=('' '-Nord' '-Dracula' '-Gruvbox' '-Everforest' '-Autmn' '-Catppuccin' '-Oxocarbon' '-Kanagawa' '-Crimson' '-Graphite' '-Rosepine' '-Flexoki' '-Slatemist')
...
OPTIONS:
  ...
  --tweaks                Specify versions for tweaks
                          1. [nord|dracula|gruvbox|everforest|autmn|catppuccin|oxocarbon|kanagawa|crimson|graphite|rosepine|flexoki|slatemist
|all]  (Nord/Dracula/Gruvbox/Everforest/Autmn/Catppuccin/Oxocarbon/Kanagawa/Crimson/Graphite/Rosepine/FlexokiSlatemist/all) ColorSchemes version
    ...
    --tweaks)
      ...
      for variant in $@; do
        case "$variant" in
          ...
          kanagawa)
            colorscheme='true'
            schemes+=("${SCHEME_VARIANTS[8]}")
            echo -e "\nKanagawa ColorScheme version! ..."
            shift
            ;;
          crimson)
            colorscheme='true'
            schemes+=("${SCHEME_VARIANTS[9]}")
            echo -e "\nCrimson ColorScheme version! ..."
            shift
            ;;
          graphite)
            colorscheme='true'
            schemes+=("${SCHEME_VARIANTS[10]}")
            echo -e "\nGraphite ColorScheme version! ..."
            shift
            ;;
          rosepine)
            colorscheme='true'
            schemes+=("${SCHEME_VARIANTS[11]}")
            echo -e "\nRosepine ColorScheme version! ..."
            shift
            ;;
          flexoki)
            colorscheme='true'
            schemes+=("${SCHEME_VARIANTS[12]}")
            echo -e "\nFlexoki ColorScheme version! ..."
            shift
            ;;
          slatemist)
            colorscheme='true'
            schemes+=("${SCHEME_VARIANTS[13]}")
            echo -e "\nSlatemist ColorScheme version! ..."
            shift
            ;;
          all)
            colorscheme='true'
  ...
  if [[ "$scheme" != '' ]]; then
    case "$scheme" in
      ...
      -Oxocarbon)
        ...
        ;;
      -Kanagawa)
        scheme_color='kanagawa'
        ;;
      -Crimson)
        scheme_color='crimson'
        ;;
      -Graphite)
        scheme_color='graphite'
        ;;
      -Rosepine)
        scheme_color='rosepine'
        ;;
      -Flexoki)
        scheme_color='flexoki'
        ;;
      -Slatemist)
        scheme_color='slatemist'
        ;;
    esac
